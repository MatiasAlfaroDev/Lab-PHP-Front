    ...
    <div className="p-4 md:p-8 max-w-5xl mx-auto">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between mb-6">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <input className="border border-border rounded px-4 py-2 text-sm bg-surface text-ink placeholder-ink-muted focus:outline-none focus:ring-2 focus:ring-ink w-full sm:w-48" placeholder="Buscar usuario..." />
          <select className="border border-border rounded px-4 py-2 text-sm bg-surface text-ink focus:outline-none w-full sm:w-auto">
      ...
      <div className="border border-border rounded overflow-x-auto">
        <div style={{ minWidth: "580px" }}>
          ...
          {users.map((u) => (
            <div key={u.name} className="grid grid-cols-12 px-5 py-4 border-b border-border last:border-b-0 items-center hover:bg-bg transition-colors bg-surface">
